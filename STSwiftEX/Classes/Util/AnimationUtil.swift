...
public struct AnimationUtil {

    /// Animation by changing the rotate using transform
    ///
    /// - Parameters:
    ///   - fromValue: the initial value of the animation
    ///   - toValue: the final value o the animation
    /// - Returns: a CABasicAnimation objec
    public static func rotateAnim(from:Float = 0,to:Float = 2 * Float(Double.pi), duration:Double = 3) -> CABasicAnimation {
    ...
    public static func scaleAnim(from:Float = 1,to:Float = 0.9,duration:Double = 1.5) -> CABasicAnimation {
